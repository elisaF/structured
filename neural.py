...
def get_structure(name, input, mask_parser_1, mask_parser_2, mask_multiply, mask_add, mask):
    def _getDep(input, mask1, mask2, mask_multiply, mask_add, mask):
        ...
        str_scores, str_scores_no_root, LL, LL_masked = _getMatrixTree(raw_scores_root, raw_scores_words, mask1, mask2, mask_multiply, mask_add)
    ...
    def _getMatrixTree(r, A, mask1, mask2, mask_multiply, mask_add):
        ...
        return d, d_no_root, LL, LL_masked
