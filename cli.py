...
parser.add_argument("--clip_ratio", default=0.0, type=float)
...
parser.add_argument("--tree_percolation", default="parent", choices=["parent", "child", "both"])
parser.add_argument("--skip_doc_bilstm", action='store_true')
parser.add_argument("--skip_sent_attention", action='store_true')
