...
def prepare_for_parse(csv_file, save_dir):
    filtered_ids = [199901031074147, 199906291119458, 199906271119108, 199906061113144, 199905041105000, 200211241443485, 200211261443784, 200212301452790, 200206301404864, 200204091382536, 200203261378921, 200303091470739, 200301041453704, 200306151496814, 200304131480441, 200305271492132, 200308051509711, 200312161543532, 200311041532615, 200311111534484, 200311111534431, 200003151184044, 200012051252657, 200012181256305, 200004111191094, 200005281203081, 200001091167261, 200001211170190, 200011191248371, 200010241241387, 200010201240338, 200111041340205, 200111111341715, 200103041275098, 200103111276845, 200106051299047, 200105221295369, 200112181352345, 200110281337845, 200612141811814, 200606201770426, 200607021773241, 200610081795542, 200608131782426, 200608311786644, 200601221733967, 200601311736132, 200609261792791, 200609051787682, 200609151790133, 200605071759812, 200702271829346, 200703181833687, 200706171854923, 200704171840918, 200705061845223, 200705161847803, 200402031555863, 200410311623587, 200406211591126, 200407261599582, 200409121610896, 200412051632355, 200411071625610, 200405231583888, 200405301585427, 200511261720276, 200511291721005, 200512271727813, 200512061722746, 200506101679000, 200508031691982, 200510161709972]
    filtered_ids = [str(id) for id in filtered_ids]
    with open(csv_file, 'rb') as f:
        ...
        for row in reader:
            ...
            if id not in filtered_ids:
                with open(os.path.join(save_dir, id + "_" + label + ".txt"), 'wb') as fout:
                    fout.write(text)
